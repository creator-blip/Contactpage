                ...
                <div className="bg-white rounded-2xl p-6 mb-8 border border-slate-200 shadow-sm">
                    <div className="space-y-4">
                        <a
                            ...
                            className="w-full bg-green-600 text-white px-6 py-3 rounded-lg flex items-center justify-center space-x-2 hover:bg-green-700 transition-colors"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full bg-red-600 text-white px-6 py-3 rounded-lg flex items-center justify-center space-x-2 hover:bg-red-700 transition-colors"
                        >
                            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full bg-violet-700 text-white px-6 py-3 rounded-lg flex items-center justify-center space-x-2 hover:bg-violet-800 transition-colors"
                        >
